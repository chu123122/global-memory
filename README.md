...
| 能力边界 | core / optional / experimental / legacy 已分层；143 个 harness 脚本均有能力归属 | [docs/capabilities.md](docs/capabilities.md) / `python harness\scripts\check_capability_manifest.py --json` |
